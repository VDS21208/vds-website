...
A lot of community-camera programs operate on a standing-access model: an agency, once authorized, can view a property's cameras at any time. VDS does not support that model on Axon-Fusus or anywhere else. Two reasons. First, it muddies legal questions about reasonable expectation of privacy for tenants, employees, customers, and visitors. Second, it makes the property owner's p